{capture assign="headData"}
    ...
    <script type="text/javascript" src="{'/admin/javascript/system/backlinkOnLoad.js'|resurl}"></script>
{/capture}

{include file='includes/header.tpl' page="system" title="{'systemBacklink_html_title'|lang}" metaDescription="{'systemBacklink_meta_description'|lang}"}  
...
<div id="show_arbo">
<a href="{'/admin/system'|url}">{'menuMenuHeader_system'|lang}</a> &gt; <a href="{'/admin/system/backlink'|url}">{'menuLeftSystem_backlink'|lang}</a>
</div>

<div class="title_h_1">
<h1>{'systemBacklink_h1'|lang}</h1>
</div>
<div class="column_in">
...
{'systemBacklink_backlinks_checked'|lang}: <b><span id="taskParsedItems">0</span></b> 
<br/>
...
{'systemBacklink_desc1'|lang}<br />
{'systemBacklink_desc2'|lang}<br /><br />
