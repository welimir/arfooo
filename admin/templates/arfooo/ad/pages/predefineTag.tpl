...
{include file='includes/header.tpl' page="ad" title="{'predefineTag_html_title'|lang}" metaDescription="{'predefineTag_meta_description'|lang}"} 
...
<div id="show_arbo">
<a href="{'/admin/ad'|url}">{'menuMenuHeader_ad'|lang}</a> &gt; <a href="{'/admin/ad/in/predefineTag'|url}">{'menuLeftAd_ad_predefine_tags'|lang}</a>
</div>

<div class="title_h_1">
<h1>{'predefineTag_h1'|lang}</h1>
</div>
<div class="column_in">
{'predefineTag_desc1'|lang}<br />
{'predefineTag_desc2'|lang}<br />
{'predefineTag_desc3'|lang}<br /><br />
{'predefineTag_desc4'|lang}
</div>
...
{'Root'|lang} &gt; {'predefineTag_tags'|lang}
</div>
